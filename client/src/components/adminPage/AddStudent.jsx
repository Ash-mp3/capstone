        ...
        <div className="pt-8 mb-4">
            ...
            <form className="flex flex-col items-center justify-around w-full max-w-md mx-auto p-5 shadow-md rounded-md h-full bg-white" onSubmit={handleSubmit}>
                ...
                <div className="w-full flex justify-center ">
                    <Button className="mb-4" style={buttonStyle} onMouseEnter={toggleHover} onMouseLeave={toggleHover} type="submit">
                        Submit
                    </Button>
                    <Snackbar open={openSnack} autoHideDuration={6000} onClose={handleSnackClose} action={action} anchorOrigin={{ vertical: 'top', horizontal: 'right' }}>
                        <Alert onClose={handleSnackClose} severity={addUserStatus ? 'success' : 'error'} ariant="filled" x={{ width: '100%' }}>
                            {addUserMsg}
                        </Alert>
                    </Snackbar>
                </div>
