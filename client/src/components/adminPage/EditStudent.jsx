		...
		<div>
			...
			<Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
				...
				<DialogContent>
					...
					<TextField autoFocus margin="dense" name="first_name" label="Name" type="text" value={editedUser.first_name} onChange={handleChange} fullWidth />
					...
					<TextField margin="dense" name="password" label="Password" type="password" value={"*****"} onChange={handleChange} fullWidth />
