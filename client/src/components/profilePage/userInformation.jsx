        ...
        <div id='userInfo&Contact' className='flex w-full justify-center'>
            <div id='userDetails' className='w-1/3 border-2 border-solid border-black place-self-center rounded-md grid grid-col-2 place-content-center py-2 mx-2 my-2 overflow-auto h-full'>
                ...
                <div id='userFields' className='grid grid-col-1 place-content-center m-2'>
                    <div id='userInfoSubSection' className='w-1/2'>
                        ...
                        <input type="text" id='username' className='m-1 p-[2px]' placeholder={username} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                        <h4 className='m-1'>Email</h4>
                        <input type="text" id='email' className='m-1 p-[2px]' placeholder={email} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                        <h4 className='m-1'>Password</h4>
                        <input type="text" id='password' className='m-1 p-[2px]' placeholder={'*****'} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                        <h4 className='m-1'>First Name</h4>
                        <input type="text" id='first_name' className='m-1 p-[2px]' placeholder={firstName} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                        <h4 className='m-1'>Last Name</h4>
                        <input type='text' id='last_name' className='m-1 p-[2px]' placeholder={lastName} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                    </div>
                </div>
            </div>
            <div id='userContact' className='w-1/3 border-2 border-solid border-black place-self-center rounded-md grid grid-col-2 place-content-center my-2 mx-2 py-2 overflow-auto h-full'>
                ...
                <div id='contactFields' className = 'grid grid-col-1 place-content-center m-2'>
                    ...
                    <input id='address' className='m-1 p-[2px]' placeholder={address} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                    <h4 className='m-1'>City</h4>
                    <input id='city' className='m-1 p-[2px]' placeholder={city} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                    <h4 className='m-1'>Country</h4>
                    <input id='country' className='m-1 p-[2px]' placeholder={country} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>   
                    <h4 className='m-1'>Phone #</h4>
                    <input id='phone_number' className='m-1 p-[2px]' placeholder={phoneNum} readOnly={!isEditable} disabled={!isEditable} style={{ backgroundColor: isEditable ? "#D8D8D8" : "white", color: isEditable ? "black" : "grey", borderRadius: "5px" }} onChange={handleInputChange}></input>
                </div>
            </div>
        </div>
